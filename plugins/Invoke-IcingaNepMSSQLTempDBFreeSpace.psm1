...
.NOTES
    ...
    - no check on number of files and relative sizes (should be identical)
#>

function Invoke-IcingaNepMSSQLTempDBFreeSpace()
{
    param (
    ...
    $DatabaseFiles             = Get-IcingaNepMSSQLTempDBFreeSpace -SqlConnection $SqlConnection 
    ...
    $RootCheckPackage = New-IcingaCheckPackage -Name 'MSSQL TempDB Free Space'  -OperatorAnd -Verbose $Verbosity
